...
// Use only safe asset filenames (no parentheses or unusual characters)
import bgDesktop1 from "../assets/DSC05054.jpg";
import bgDesktop2 from "../assets/DSC06407.jpg";
import bgDesktop3 from "../assets/DSC05057.jpg";

import bgTablet1 from "../assets/DJI_20250825112534_0610_D.jpg";
import bgTablet2 from "../assets/DSC05048.jpg";
import bgMobile1 from "../assets/DSC05048.jpg";
import bgMobile2 from "../assets/DSC05054.jpg";
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden text-white hero">
      ...
      <div className="absolute inset-0 z-0">
        {bgImages.map((bg, index) => (
          <div
            key={index}
            className={`absolute inset-0 bg-center bg-cover transition-opacity duration-1000 ${index === currentBg ? "opacity-100 scale-105" : "opacity-0 scale-100"
              }`}
            style={{
